...
var PushNotification = /** @class */ (function () {
    ...
    PushNotification.prototype.requestIOSPermissions = function (options) {
        ...
        react_native_1.PushNotificationIOS.requestPermissions(options);
    };
    ...
    PushNotification.prototype._checkIfOpenedByCampaign = function (nextAppState) {
        ...
        if (this._currentState.match(/inactive|background/) &&
            nextAppState === 'active') {
            react_native_1.PushNotificationIOS.getInitialNotification()
                .then(function (data) {
                if (data) {
